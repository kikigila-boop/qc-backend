...
from ..database import get_db, engine as neon_engine
...
def migrate_from_supabase(supabase_url: str):
    """
    Copy all data from Supabase to the current Neon database.
    Call with: POST /migrate/from-supabase?supabase_url=<url>
    """
    results = {}
    try:
